...
export async function POST(req: Request) {
    try {
        const { query, currentDistribution } = await req.json();
        ...
        1️⃣ Advice: Provide financial guidance based on the user's input. This should be clear, concise, and actionable.
        2️⃣ Updated Budget Distribution: Suggest a revised budget allocation.
        ...
        Note-2: The sum of all the amounts in updatedBudget should be equal to the total income of the user and the amount of other categories should can be changed to maintain the sum.
